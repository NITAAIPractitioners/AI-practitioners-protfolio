...
@app.route("/")
def hello_world():
  students = load_projects_from_db()
  return render_template('home.html', myskills=students, myname='Girls')


@app.route("/project/<id>")
def show_project(id):
  project = load_project_from_db(id)
  return render_template('studentdetails.html', project=project)
